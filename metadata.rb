...
license          "Apache 2.0"
description      "Acts as a base recipe for chef-client and security components (ldap/yubikey two factor authentication)."
version          "1.0.0"
recipe           "nmdbase::default", "Enables the chef-client service on a schedule in addition to each of the other recipes in this cookbook."
