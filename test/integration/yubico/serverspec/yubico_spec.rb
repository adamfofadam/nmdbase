...
describe file('/etc/pam.d/sshd') do
  ...
  its(:content) { should match '^auth required pam_yubico.so mode=client try_first_pass id=15916 key=iqXJ1Moo70WCI4wrxBpniqvPDiw= authfile=/etc/yubikey_mappings$' }
end
